...
def test_a3_no_false_positive_on_committed_spain_sample():
    ...
    # الملفّ عربيٌّ مُلتزَم في المستودع؛ `open` بلا ترميز يأخذ ترميزَ المنصّة
    # (cp1252 على ويندوز) فينهار على أوّل بايتٍ غير لاتيني — عطلُ بيئةٍ يُقرأ
    # كأنه فشلُ حارس، وهو آخرُ موضعٍ في المستودع كان يفعلها.
    spain = open(os.path.join(root, "samples", "research_report_latest.md"),
                 encoding="utf-8").read()
