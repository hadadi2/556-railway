...
def test_compare_own_price_no_own_price_given():
    ...
    findings = [DataPoint({"price": p, "currency": "USD", "pack_size": "1 kg"}, "Local retail", 0.6, "") for p in [100, 80]]
    out = lp.compare_own_price(None, findings, currency="USD", pack_size="1 kg")
...
def test_compare_own_price_percentile_math():
    ...
    findings = [DataPoint({"price": p, "currency": "USD", "pack_size": "1 kg"}, "Local retail", 0.6, "") for p in [100, 80, 60]]
    out = lp.compare_own_price(70.0, findings, currency="USD", pack_size="1 kg")
