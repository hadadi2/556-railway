...
def test_sampling_params_absent_for_the_repo_default_model(monkeypatch):
    """`claude-opus-4-8` — كان نموذج هذا الريبو الافتراضي (الافتراضي اليوم
    `claude-sonnet-5`، رافض هو الآخر) ويرفض المعاملات: تُحذف كلّياً. هذا هو الاختبار الذي كان سيلتقط أن قائمةً
