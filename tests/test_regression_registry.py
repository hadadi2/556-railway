...
_LESSONS = {
    ...
    271: lambda: (
        ...
        _needles("silk_economics.py", "def _price_res",
                 "_N.currency_tokens()")(),
        _absent("silk_economics.py", "_PRICE_IN_TEXT_RE = _re.compile(")(),
        _needles("silk_render.py", "def _is_price_row",
                 'and _is_price_row(row["value"], row["note"])')(),
        _needles("silk_reports.py",
                 'if not _is_price_row(r.get("value"), r.get("note"))')(),
        _needles("tests/test_report7_p0.py",
                 "def test_the_client_price_section_prints_each_observation_once")(),
        _needles("tests/test_lessons_enforcement.py", "(271, ")()),
    270: lambda: (
        _needles("silk_economics.py", "def hhi_fact", "_hhi = hhi_fact(dr, _entries)",
                 "def _year_position")(),
        _needles("silk_fact_ledger.py", "def _hhi_winner")(),
        _needles("silk_render.py", '"metric": "hhi"')(),
        _absent("silk_render.py", "def _hhi_provenance")(),
        _needles("silk_quality_gate.py", "def _check_chart_metric_identity",
                 "findings += _check_chart_metric_identity(dr, view.get(\"ledger\"))")(),
        _needles("tests/test_report7_p0.py",
                 "def test_hhi_value_year_and_source_come_from_one_record")(),
        _needles("tests/test_lessons_enforcement.py", "(270, ")()),
    269: lambda: (
    ...
    246: lambda: (
        ...
        _needles("silk_profiles.py", "_MARKET_SECTIONS", "def _check_region",
                 "HS_SCOPES")(),
        _needles("silk_quality_gate.py",
                 "def _check_regime_not_belonging_to_country",
                 "def _check_zero_fx_volatility", "_NAMED_GATEWAY_RE")(),
        _needles("silk_missions.py", "def scope_instructions")(),
        _needles("silk_style_contract.py", "def lead_activity_allowed")(),
        _absent("silk_missions.py",
                '"اذكر شهادات الحلال/SONCAP/CIQ/SFDA متى انطبقت. إن أعاد "')(),
        _needles("tests/test_lessons_enforcement.py", '(246, ')()),
    245: lambda: (
    ...
    243: lambda: (
        _needles("silk_narrative.py", "def fmt_derived", "def iso_currency",
                 ...
                 "def derived_provenance_enabled")(),
        _needles("silk_economics.py", "def _unit_cur", "inputs=",
                 "unknown=")(),
        _needles("silk_quality_gate.py",
                 "def _check_reference_to_nonexistent_figure",
                 "def _check_max_loss_without_components",
                 "def _dn_needle")(),
        _needles("silk_ai_judge.py", "_derived_rule")(),
        _needles("tests/test_lessons_enforcement.py", '(243, ')()),
    242: lambda: (
        _needles("silk_decision.py", "CORE_PILLARS",
                 "def confidence_band_cap", "def score_arithmetic",
                 "CONFIDENCE_AGE_DECAY", "withheld_reason")(),
        _needles("silk_style_contract.py", "_BAND_ORDER")(),
        _needles("silk_render.py", "def confidence_discipline",
                 "verification_rate_pct")(),
        _needles("silk_quality_gate.py",
                 "def _check_high_confidence_with_missing_pillar")(),
        _needles("tests/test_lessons_enforcement.py", '(242, ')()),
    241: lambda: (
    ...
    238: lambda: (
        ...
        _needles("silk_quality_gate.py",
                 ...
                 "_XSEC_SIM_DEFAULT")(),
        _needles("tests/test_lessons_enforcement.py", '(238, ')()),
    237: lambda: (
    ...
    235: lambda: (
        ...
        _needles("silk_style_contract.py", "REFERENTIAL_INTEGRITY_RULE")(),
        _needles("tests/test_lessons_enforcement.py", '(235, ')()),
    234: lambda: (
