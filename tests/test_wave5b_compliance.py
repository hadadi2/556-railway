...
def test_acceptance_4_tiers_visibly_differ():
    ...
    # تصحيح 2026-08-17 (تغيير عقدٍ مقصود): GBR كانت موسومة «مقنّن بالكامل»
    # بينما `_matches` يوسّع صفوف "EU" إلى EU27 فقط — فتخرج بريطانيا بالوسم
    # الأعلى **و**بقائمة فارغة «غير مغطاة بالمرجع الثابت» معاً. الوسم الصادق
    # «موثّق جزئياً» حتى تُضاف صفوف retained-EU-law باستشهاد legislation.gov.uk.
