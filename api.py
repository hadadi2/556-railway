...
def create_app():
    ...
    class ResearchRequest(BaseModel):
        ...
        # **والافتراضُ الفعليّ "decision" لا "academic"** — وقارئُه
        # الوحيد `silk_research_pipeline._default_report_style`. (كان
        # هذا التعليق يقول "academic" فخالَف الشيفرةَ — نفسُ عائلة
        # الصنف ١٩: حدٌّ مُعلَنٌ يخالف المقيس.) قيمةٌ صريحة في الطلب
        # تتقدّم على البيئة.
