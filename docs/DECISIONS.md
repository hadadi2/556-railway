...
> **ملحق 2026-08-21 — الدمج المُكيَّف (قرار مالك).** ظلّ هذا الفرع (#139)
> شهراً بلا دمج بينما نفّذ main جوهرَه بطرقٍ أحدث (اللائحة ٣٩: الجدول تلميحٌ
> لا حاكم؛ #141 صمّام فشل-آمن؛ #177 عتبة مقيسة؛ #178 حوار المصدر الرسمي)
> وأمر المالك بعده بيومين (2026-07-23) بحسمٍ حتميٍّ مجانيٍّ لزبدة الفول
> السوداني — ما يناقض «النموذج لكل منتج». عند الدمج اختار المالك التكييف:
> **أُخذ** ملف القائمة الرسمية (`data/hscodes_full.csv` بكلماتٍ مُرحَّلة من
> بذرة اليوم) وبطارية اختبارات الاتساع وحارس `ensureHs`؛ **ولم يُطبَّق** عكس
> التدفّق (البندان ٣/٤ أدناه تاريخيان — الحتميّ ما زال يقترح ويحسم الواضح
> مجاناً). قائمة المطابقة اتحاد الرسمية + رموز البذرة الـ١٣ التي أعاد HS2022
> ترقيمها (150910…) — ترحيلُها لخلفائها يتطلّب جداول الربط الرسمية WCO بموجةٍ
> مستقلة، لا يُخترَع (سابقة سوء ربط الكويت). تعادل درجات الاحتواء صار يُحسَم
> **بالأخصّية** (أطول كلمةٍ مطابقة) لا بترتيب الملف — انحدار «زيت زيتون بكر
> ممتاز → 071120» المُثبَت أثناء الدمج هو الدليل. القرّاء متسامحون مع
> المخطّطين (`keywords_ar` ثم `name_ar/keywords`).
