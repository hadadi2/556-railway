...
MANDATED_OUTPUT_LITERALS: tuple = (
    ...
    # سطر الأسعار المرصودة بلا بطاقة منتج
    "أسعار السوق مرصودة؛ تحديد موقعك السعري يتطلب سعر المصنع "
    "للكيلوغرام (التكلفة/كجم).",
    "Market prices are observed; positioning your own price "
    "requires your ex-factory price per kilogram.",
...
def _voice_lead(lang: str = "ar") -> str:
    ...
    return ("الصوت والأسلوب — عربية استشارية خليجية طبيعية، لا بنية إنجليزية "
...
def deep_report(mission_reports: dict, analyst_summary: str, verdict: dict,
    ...
    parts.append(
        ...
        "حساب سعره/كجم يحمل **سبباً صريحاً في خليّته** («الوزن غير متاح» أو "
        "«وحدة غامضة») لا خانةً فارغة؛ واذكر المعطى الوحيد الذي يفتح "
        "الحساب — «سعر المصنع للكيلوغرام (التكلفة/كجم)» — **مرّة واحدة** "
    ...
    parts.append(
        ...
        + ("'Market prices are observed; positioning your own price "
           ...
           "'أسعار السوق مرصودة؛ تحديد موقعك السعري يتطلب سعر المصنع "
           "للكيلوغرام (التكلفة/كجم).'")
        + " — لا تُحِل القارئ إلى مدخلات النظام، "
        "ولا تكتب 'لا تسعير' أو ما يُفهم منه غياب الأسعار "
        ...
        "'التوصية <X> لأن <أقوى الأسباب بأرقامها>؛ وتتحول "
        "إلى GO إذا <شرطان قابلان للقياس>' — سطرُ التوصية وحده أولاً، ثم "
