...
def kuwait_research_blob() -> dict:
    ...
    missions = {
        ...
        # الموجة C (E-10): مفتاحُ الإنتاج — كان اسماً لا وجودَ له في
        # `silk_missions.MISSIONS`، فلا تُقرأ البعثةُ ولا يُمرَّن مسارُها.
        "competitors": _m("HHI 2900 — سوق مركّز (تحت الرمز 040510)",
        ...
        # الموجة C (E-10): مفتاحُ الإنتاج — كان اسماً لا وجودَ له في
        # `silk_missions.MISSIONS`، فلا تُقرأ البعثةُ ولا يُمرَّن مسارُها.
        "demographics_economy": _m("دخل فرد مرتفع نسبياً (2021)",
